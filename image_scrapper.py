                ...
                for real_image in images:
                    if real_image.get('data-reactid') is not None:
                        if '&w=60&h=60&c=7' not in real_image.get('src'):
                            ...
                            if not os.path.isdir("F:\SoccerPlayer_image_2/" + keyword + "/"):
                                os.mkdir("F:\SoccerPlayer_image_2/" + keyword + "/")
                            full_name = "F:\SoccerPlayer_image_2/" + keyword + "/" + str(name) + ".jpg"
                            down_cnt += 1
